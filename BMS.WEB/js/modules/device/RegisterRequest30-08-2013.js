Ext.onReady(function() {
    ...
    var functionaryStore = new Ext.data.Store({
        ...
        var MasterGrid = new Ext.grid.GridPanel({
			...
			{ header: 'Documento Identificaci&oacute;n', width: 140, dataIndex: 'DocumentNumberEntryPerson' },
			{ header: 'Nombre Persona Ingresa', width: 160, dataIndex: 'NameEntryPerson' },
			{ header: 'Cargo', width: 120, dataIndex: 'ChargeEntryPerson' },
			{ header: 'Sede', width: 120, dataIndex: 'HeadquarterEntryPerson' },
			{ header: 'Centro de Costo', width: 180, dataIndex: 'CostCenterEntryPerson' },
			{ header: 'Empresa', width: 160, dataIndex: 'CompanyEntryPerson' },
			...
			{ header: 'Dispositivo Biom&eacute;trico', width: 120, dataIndex: 'BiometricDeviceIP' },
