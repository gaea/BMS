<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegisterAuthorization.aspx.cs" Inherits="BMS.WEB.pages.authorization.RegisterAuthorization" %>
        ...
        <form id="UserForm" runat="server">
            <asp:ScriptManager 
                ...
                <Scripts>
                    ...
                    <asp:ScriptReference Path="~/js/modules/authorization/RegisterAuthorization.js" />
                </Scripts>
            </asp:ScriptManager>
        </form>
    </body>
