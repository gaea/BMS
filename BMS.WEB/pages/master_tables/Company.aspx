<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Company.aspx.cs" Inherits="BMS.WEB.pages.Company" %>
        ...
        <form id="UserForm" runat="server">
            <asp:ScriptManager 
                ...
                <Scripts>
                    ...
                    <asp:ScriptReference Path="~/js/modules/master_tables/Company.js" />
                </Scripts>
            </asp:ScriptManager>
        </form>
    </body>
