<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dependency.aspx.cs" Inherits="BMS.WEB.pages.Dependency" %>
        ...
        <form id="UserForm" runat="server">
            <asp:ScriptManager 
                ...
                <Scripts>
                    ...
                    <asp:ScriptReference Path="~/js/modules/master_tables/Dependency.js" />
                </Scripts>
            </asp:ScriptManager>
        </form>
    </body>
