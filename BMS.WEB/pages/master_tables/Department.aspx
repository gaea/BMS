<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Department.aspx.cs" Inherits="BMS.WEB.pages.Department" %>
        ...
        <form id="UserForm" runat="server">
            <asp:ScriptManager 
                ...
                <Scripts>
                    ...
                    <asp:ScriptReference Path="~/js/modules/master_tables/Department.js" />
                </Scripts>
            </asp:ScriptManager>
        </form>
    </body>
