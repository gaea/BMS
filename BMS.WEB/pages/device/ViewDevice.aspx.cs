...
namespace BMS.WEB.pages.device
{
    public partial class ViewDevice : System.Web.UI.Page
    {
        ...
        public string List(int start, int limit)
        {
            ...
            DataResponse<TMA.MODEL.Entity.Device> dataResponse = new DataResponse<TMA.MODEL.Entity.Device>();

            try
            {
                dataResponse.Result = DevicesDao.findAll(start, limit);
                dataResponse.Total = DevicesDao.Count();
